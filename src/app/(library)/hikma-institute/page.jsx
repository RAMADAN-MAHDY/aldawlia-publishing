        ...
        <div className="bg-white text-right font-sans leading-relaxed text-gray-800" dir="rtl">
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex-shrink-0">
                        <img
                            ...
                            className="w-24 h-24 md:w-36 md:h-36 object-contain bg-white p-2 rounded-2xl shadow-lg border-2 border-[#C5A059]"
                        />
                    </div>

                    <div className="text-right flex-grow">
                        <h1 className="text-3xl md:text-5xl font-black mb-2 text-white">معهد الحكمة الدولي للدراسات الاستراتيجية</h1>
                        <p className="text-xl md:text-2xl font-bold tracking-widest mb-4 uppercase text-[#C5A059]">International Wisdom Institute (IWI)</p>
                        ...
                        <div className="mt-6 text-base opacity-95 leading-relaxed text-white">
                            <p className="font-bold text-[#C5A059] mb-1">الهوية المؤسسية الجديدة:</p>
            ...
            <main className="max-w-7xl mx-auto px-4 md:px-8 py-12">
                ...
                <section className="mb-12">
                    <h3 className="text-3xl font-bold text-sky-900 mb-6 border-r-8 border-[#C5A059] pr-4">أولًا: الفكرة الأساسية للمعهد (The Core Idea)</h3>
                ...
                <section className="mb-12 grid lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-8">
                        <div className="p-6 bg-sky-900 text-white rounded-2xl shadow-lg">
                            <h4 className="font-bold text-[#C5A059] text-2xl mb-4">3️⃣ الرسالة (Mission)</h4>
                        ...
                        <div className="p-6 bg-sky-50 rounded-2xl border-2 border-[#C5A059] shadow-sm">
                ...
                <section className="mb-12">
                    <h4 className="text-3xl font-bold text-sky-900 mb-8 border-r-4 border-[#C5A059] pr-4">5️⃣ الأهداف الاستراتيجية (Strategic Objectives)</h4>
                ...
                <section className="grid lg:grid-cols-2 gap-12 mb-12 p-8 bg-sky-50 rounded-[2rem] border border-sky-100 shadow-sm">
                    <div>
                        <h4 className="text-2xl font-bold text-sky-900 mb-8 underline decoration-[#C5A059] underline-offset-8">6️⃣ مجالات البحث (Research Domains)</h4>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-base font-bold">
                            <div className="bg-white p-4 rounded-xl flex items-center gap-3 shadow-sm border border-gray-100">
                                <span className="text-[#C5A059] text-xl">●</span> الجغرافيا السياسية
                            </div>
                            <div className="bg-white p-4 rounded-xl flex items-center gap-3 shadow-sm border border-gray-100">
                                <span className="text-[#C5A059] text-xl">●</span> الاستراتيجية الدولية
                            </div>
                            <div className="bg-white p-4 rounded-xl flex items-center gap-3 shadow-sm border border-gray-100">
                                <span className="text-[#C5A059] text-xl">●</span> تحولات النظام العالمي
                            </div>
                            <div className="bg-white p-4 rounded-xl flex items-center gap-3 shadow-sm border border-gray-100">
                                <span className="text-[#C5A059] text-xl">●</span> الأمن الدولي
                            </div>
                            <div className="bg-white p-4 rounded-xl flex items-center gap-3 shadow-sm border border-gray-100">
                                <span className="text-[#C5A059] text-xl">●</span> الاقتصاد الجيوسياسي
                            </div>
                            <div className="bg-white p-4 rounded-xl flex items-center gap-3 shadow-sm border border-gray-100">
                                <span className="text-[#C5A059] text-xl">●</span> دراسات القوة والنفوذ
                            </div>
                        </div>
                    </div>
                    <div>
                        <h4 className="text-2xl font-bold text-sky-900 mb-8 underline decoration-[#C5A059] underline-offset-8">7️⃣ أنشطة المعهد (Activities)</h4>
                ...
                <section className="mb-12 py-12 px-6 md:px-10 bg-white border border-gray-200 rounded-[3rem] shadow-sm">
                    <h3 className="text-3xl font-black text-sky-900 mb-12 text-center underline decoration-[#C5A059] underline-offset-8">الأقسام البحثية للمعهد</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={i} className="bg-sky-900 text-white p-6 rounded-2xl border-r-8 border-[#C5A059] shadow-lg flex flex-col justify-center">
                                <h6 className="font-bold text-lg mb-3 text-[#C5A059] underline decoration-white border-b border-transparent leading-relaxed">{dept.name}</h6>
                ...
                <section className="mb-16">
                    <h4 className="text-3xl font-bold text-sky-900 mb-10 border-r-4 border-[#C5A059] pr-4">الوحدات الاستراتيجية المتخصصة</h4>
                ...
                <section className="mb-4 bg-gray-900 text-white py-12 px-6 md:px-10 rounded-[3rem] shadow-2xl">
                    <h4 className="text-3xl font-bold text-[#C5A059] mb-10 text-center">المرحلة القادمة: الهيبة والهيكل المؤسسي</h4>
                    <div className="flex flex-wrap justify-center gap-4 md:gap-6">
                        {[
                            ...
                            <span key={i} className="bg-sky-900 px-6 py-4 rounded-xl text-base md:text-lg font-bold border border-sky-600 shadow-md hover:bg-[#C5A059] transition-colors cursor-default text-center text-white">
                                {name}
                            </span>
                        ))}
                    </div>
                    <p className="mt-12 text-center text-xl md:text-2xl font-black italic text-[#C5A059] tracking-widest">"حكمة الرؤية.. قوة التحليل"</p>
                </section>

            </main>

            {/* Footer Branding */}
            <footer className="bg-sky-950 text-white py-16 px-8 text-center border-t-8 border-[#C5A059]">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-base md:text-lg opacity-80 italic mb-8 tracking-[0.2em] text-[#C5A059]">Strategic & Geopolitical Studies</p>
                    <div className="w-24 h-1 bg-[#C5A059] mx-auto mb-8 rounded-full"></div>
