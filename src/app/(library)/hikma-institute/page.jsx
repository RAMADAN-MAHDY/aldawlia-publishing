...
export default function AlhekmaInstitutePage() {
    // إعدادات الحركة الافتراضية للسكشنات
    const fadeInUp = {
    ...
    return (
        <div className="bg-white text-right font-sans leading-relaxed text-gray-800" dir="rtl">
            ...
            <main className="max-w-7xl mx-auto px-4 md:px-8 py-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {["الحكمة الفكرية", "التحليل الاستراتيجي", "قراءة التحولات الجيوسياسية"].map((item, idx) => (
                                <motion.div 
                                    key={idx}
                                    whileHover={{ y: -5 }}
                                    className="bg-white p-6 rounded-2xl shadow-md font-bold text-center border-b-4 border-sky-600 text-sky-900 text-lg"
                                >
                                    {item}
                                </motion.div>
                            ))}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-lg">
                        {[
                            ...
                            <motion.div 
                                ...
                                className="bg-white border border-gray-200 p-5 rounded-xl flex items-center gap-4 shadow-sm"
                            >
                ...
                <motion.section 
                    className="grid lg:grid-cols-2 gap-12 mb-12 p-8 bg-sky-50 rounded-[2rem] border border-sky-100 shadow-sm"
                    {...fadeInUp}
                >
                    <div>
                ...
                <motion.section className="mb-12 py-12 px-6 md:px-10 bg-white border border-gray-200 rounded-[3rem] shadow-sm" {...fadeInUp}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <motion.div 
                                key={i} 
                                whileHover={{ y: -10 }}
                                className="bg-sky-900 text-white p-6 rounded-2xl border-r-8 border-amber-600 shadow-lg flex flex-col justify-center"
                            >
                ...
                <motion.section className="mb-16" {...fadeInUp}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            ...
                            { title: "5️⃣ وحدة البيانات والتحليل", desc: "بناء قواعد بيانات استراتيجية شاملة، تحليل الاتجاهات العالمية، تحليل المخاطر ودعم الدراسات.", full: true }
                        ].map((unit, i) => (
                ...
                <motion.section 
                    className="mb-4 bg-gray-900 text-white py-12 px-6 md:px-10 rounded-[3rem] shadow-2xl"
                    ...
                    <div className="flex flex-wrap justify-center gap-4 md:gap-6">
                        {[
                            ...
                            <motion.span 
                                ...
                                className="bg-sky-900 px-6 py-4 rounded-xl text-base md:text-lg font-bold border border-sky-600 shadow-md transition-colors cursor-default text-center text-white"
                            >
                                {name}
                            </motion.span>
                        ))}
